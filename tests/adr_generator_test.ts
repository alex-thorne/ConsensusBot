...
import { formatADRForSlack, generateADRMarkdown } from "../utils/adr_generator.ts";
...
Deno.test("adr_generator - generateADRMarkdown creates valid markdown for approved decision", () => {
  const decision: DecisionRecord = {
    ...
    proposal: "We should adopt TypeScript for all new projects to improve type safety.",
  ...
  assertStringIncludes(adr, "This ADR was automatically generated by ConsensusBot");
});
...
Deno.test("adr_generator - generateADRMarkdown creates valid markdown for rejected decision", () => {
  ...
  assertStringIncludes(adr, "No implementation required as decision was rejected");
});
